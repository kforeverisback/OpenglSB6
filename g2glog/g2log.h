...
#ifdef G2GLOG_EXPORT
#define G2GLOG_API __declspec(dllexport)
#else
#define G2GLOG_API __declspec(dllimport)
#endif

class G2GLOG_API g2LogWorker;
...
void G2GLOG_API initializeLogging(g2LogWorker *logger);
 ...
 * and is not deleted. 
 */
void G2GLOG_API shutDownLogging();
...
*/
bool G2GLOG_API shutDownLoggingForActiveOnly(g2LogWorker* active);
...
/** Trigger for flushing the message queue and exiting the application
  ...
  struct G2GLOG_API FatalMessage
{
...
struct G2GLOG_API FatalTrigger
{
...
class G2GLOG_API LogContractMessage : public LogMessage
{
public:
